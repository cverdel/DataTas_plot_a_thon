...
The idea behind this is to combine a simple bar chart with a shaded relief map. I've added two external datasets: digital elevation data from the Himalaya region, and a table with latitude and longitude coordinates for many of the peaks in the Himalayan database. Coordinates were compiled from many sources, but [this website] (https://www.yetitrailadventure.com/nepal/expedition-in-nepal.html) was one of the main ones.
